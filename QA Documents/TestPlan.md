...
|----------------------|----------------------------------------------------|---------------------|-----------------|
| Collision            | Correctly working collision between Pac-Man and walls        | Working             |                 |
|                      | Appropriate interaction between Pac-Man and ghosts  | In progress         |                 |
| Movement             | Smooth Pac-Mans movements                         | Working         |                 |
|                      | Responsiveness and accuracy of commands             | In progress         |                 |
| Game Mechanics       | Efficient collection of pac-dots                    | Working         |                 |
|                      | Pursuit and evasion mechanisms of ghosts            | In progress           |                 |
| Graphics             | Clear and representative maze display               | Working             |                 |
